...
namespace MathGameMvc.Controllers
{
    public class SubstractionController : Controller
    {
        ...
        public SubstractionController(ApplicationDbContext context, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Substraction(int userAnswer, int correctAnswer)
        {
